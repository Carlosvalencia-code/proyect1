    ...
    class Prisma:
        ...
        def __getattr__(self, name):
            class MockTable:
                ...
                async def find_unique(self, *args, **kwargs): return None
                async def find_many(self, *args, **kwargs): return []
...
async def startup_database():
    ...
    try:
        ...
        logger.warning(f"Aviso de base de datos en modo desarrollo/offline: {str(e)}")
