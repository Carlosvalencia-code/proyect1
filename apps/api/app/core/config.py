...
class Settings(BaseSettings):
    ...
    # Base de datos
    DATABASE_URL: str = "postgresql://synthia:synthia@localhost:5432/synthia_style_db"
    DATABASE_HOST: str = "localhost"
    DATABASE_PORT: int = 5432
    DATABASE_NAME: str = "synthia_style_db"
    DATABASE_USER: str = "synthia"
    DATABASE_PASSWORD: str = "synthia"
    
    # Seguridad
    SECRET_KEY: str = "synthia-dev-secret-key-32chars-minimum-needed-here"
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 30
    REFRESH_TOKEN_EXPIRE_DAYS: int = 7
    ALGORITHM: str = "HS256"
    
    # APIs externas
    GEMINI_API_KEY: Optional[str] = "dev-placeholder-key"
